...
if ($items != null){
    foreach ($items as $item){
        ...
        $sheet->setCellValueExplicit("D$row",$item->Bgnama,PHPExcel_Cell_DataType::TYPE_STRING);
        $sheet->setCellValueExplicit("E$row",$item->Bkode,PHPExcel_Cell_DataType::TYPE_STRING);
        $sheet->setCellValueExplicit("F$row",$item->Bnama,PHPExcel_Cell_DataType::TYPE_STRING);
        $sheet->setCellValue("G$row",$item->Bsatbesar);
        $sheet->setCellValue("H$row",$item->Bisisatkecil);
        $sheet->setCellValue("I$row",$item->Bsatkecil);
        $sheet->setCellValueExplicit("J$row",$item->Bsnama,PHPExcel_Cell_DataType::TYPE_STRING);
